...
export default function AddTableItem() {
  return (
    <div className="clear-both mt-3 mb-8 bg-white rounded-b shadow">
      <div className="flex flex-wrap justify-between items-center px-6 py-6">
        <div className="w-full">
          ...
          <div className="hidden inline-block text-right float-right ml-5 cursor-pointer">
            <svg
        ...
        <form novalidate="true" className="w-full mt-3 max-w-2xl">
          <div className="mt-3 flex flex-wrap mb-1">
            ...
            <div className="w-full">
              <button
                name="submit"
                type="submit"
                className="font-medium mt-6 py-4 px-4 leading-none text-white rounded md:rounded-l-none bg-gray-800 hover:bg-gray-900"
              >
